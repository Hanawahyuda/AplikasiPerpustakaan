...
use App\Models\UserPinjam;

class UserPinjamController extends Controller
{
    function __construct()
    {
        $this->model = new UserPinjam();
    }
    ...
    public function buat_user(Request $request)
    {
        ...
        return response([
            "pesan" => "User Peminjam Berhasil Di Input",
            "pesan_b" => true
        ], 201);
    }
    ...
    public function hapus_user($id)
    {
        ...
        return response([
            "pesan" => "User Peminjam Berhasil Dihapus",
            "pesan_b" => true
        ], 200);
    }
    ...
    public function ubah_user(Request $request)
    {
        ...
        $user->uuid_user = $request->uuid_user;
        ...
        return response([
            "pesan" => "User Peminjam Berhasil Diubah",
            "pesan_b" => true
        ], 200);
    }
}
