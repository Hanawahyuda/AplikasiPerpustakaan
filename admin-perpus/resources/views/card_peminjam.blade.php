        ...
        <dir class="form-group row">
            <div class="form-group col-sm-4">
                    <div class="card" style="align-items: center;">
                        <img src="https://public-api.qr-code-generator.com/v1/create/free?qr_code_text=$output->uuid_user" alt="QR-Code" width="300" height="400">
                        <div class="card-content">
                            <h1>{{ $output->nama_lengkap }}</h1>
                        </div>
                    </div>
                </div>
        </dir>
